...
\def\paperstatus{100} % a number from 0-100 indicating your status. 100
                % means completed
\def\paperchapter{Workflow} % This section is typically a single keyword. from
                   % a small list. Consult with theinstructors about
                   % yours. They typically fill it out once your first
                   % text has been reviewed.
\def\hid{hid-sp18-416} % all hids of the authors of this
...
\keywords{\locator\ Python Celery, Swagger REST services, Node JS, Spark, 
Hadoop}
